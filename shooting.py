...
class Background:
    ...
    def draw(self):
        for (x, y, speed) in self.star_list:
            if speed > 2.3:
                COLOR = STAR_COLOR_HIGH
            elif speed > 1.8:
                COLOR = STAR_COLOR_MIDLE
            else:
                COLOR = STAR_COLOR_LOW
...
class Item:
    ...
    def draw(self):
        pyxel.blt(self.x, self.y, 1, 66, 34, self.w, self.h, 0)



class App:
    def __init__(self):
        pyxel.init(160, 200, caption="Pyxel Shooter")
    ...
    def update_play_scene(self):
        ...
        if pyxel.frame_count % 100 == 0:
            Item(random() * (pyxel.width - PLAYER_WIDTH), 0)
    ...
    def draw_title_scene(self):
        pyxel.text(52, 66, "Pyxel Shooter", pyxel.frame_count % 16)
        pyxel.text(49, 126, "- PRESS ENTER -", 13)
